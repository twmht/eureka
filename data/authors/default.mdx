...
- **坦克辨識(無人機相關)**
  > 與無人機廠商合作，利用 few shot learning 快速識別敵軍坦克
...
- [Sherpa-ONNX](https://github.com/k2-fsa/sherpa-onnx/tree/master)
  - [Expose JNI to compute probability of chunk in VAD](https://github.com/k2-fsa/sherpa-onnx/pull/2433)
  - [fix unicode problem in windows path](https://github.com/k2-fsa/sherpa-onnx/pull/2508)
